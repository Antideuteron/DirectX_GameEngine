...
public:
  ...
  static bool CreateRenderTargets(ComPtr<ID3D12Device>& device, ComPtr<IDXGISwapChain3>& swapChain, ComPtr<ID3D12Resource> renderTargets[2], ComPtr<ID3D12DescriptorHeap>& rtvHeap, UINT& rtvDescriptorSize);
